export function Education() {
    return (<>
        <ol className="relative border-s border-gray-200 dark:border-gray-700 ml-20 my-10">
            <li className="mb-10 ms-6">
                ...
                <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">BSC. Computer Science<span className="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300 ms-3">Now</span></h3>
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">On August, 2024</time>
