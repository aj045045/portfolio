...
export function Contact({ image, data, link }: { image: any; data: string; link: string; }) {
    return (
        <motion.div whileHover={{scale:1.1}} className="flex flex-row items-center space-x-5 cursor-alias">
            <div className="text-lg text-green-700 md:text-2xl dark:text-green-400">{image}</div>
