...
export function WhoAmI() {
    return (
        <div className="w-11/12 mx-auto">
            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{delay:1,duration:0.5}} className="mt-6 text-lg md:text-xl lg:text-2xl leading-6 tracking-wider [word-spacing:10px]">My Journey</motion.div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{delay:1,duration:0.5}} className="mt-2 text-sm md:text-md lg:text-lg leading-6 text-slate-600 tracking-wider [word-spacing:10px]">My journey into the world of web programming began three years ago, motivated by a fascination with how the internet connects everyone. Since then, I&apos;ve developed my abilities through continual study and hands-on experience, working on a wide range of projects, from simple landing pages to big web applications.</motion.div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{delay:1,duration:0.5}} className="mt-6 text-lg md:text-xl lg:text-2xl leading-6 tracking-wider [word-spacing:10px]">What I Do</motion.div>
            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{delay:1,duration:0.5}} className="mt-6 text-lg md:text-xl lg:text-2xl leading-6 tracking-wider [word-spacing:10px]">Why Choose Me?</motion.div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{delay:1,duration:0.5}}>
